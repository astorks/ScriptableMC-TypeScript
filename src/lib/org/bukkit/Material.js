export class Material {
    ...
    static get ANDESITE_SLAB() {
        return this.$javaClass.ANDESITE_SLAB;
    }
    static get ANDESITE_STAIRS() {
        return this.$javaClass.ANDESITE_STAIRS;
    }
    static get ANDESITE_WALL() {
    ...
    static get ATTACHED_MELON_STEM() {
        return this.$javaClass.ATTACHED_MELON_STEM;
    }
    static get ATTACHED_PUMPKIN_STEM() {
        return this.$javaClass.ATTACHED_PUMPKIN_STEM;
    }
    static get AZURE_BLUET() {
    ...
    static get CARTOGRAPHY_TABLE() {
        return this.$javaClass.CARTOGRAPHY_TABLE;
    }
    static get CARVED_PUMPKIN() {
        return this.$javaClass.CARVED_PUMPKIN;
    }
    static get CAT_SPAWN_EGG() {
    ...
    static get CAVE_SPIDER_SPAWN_EGG() {
    ...
    static get DIORITE_SLAB() {
        return this.$javaClass.DIORITE_SLAB;
    }
    static get DIORITE_STAIRS() {
        return this.$javaClass.DIORITE_STAIRS;
    }
    static get DIORITE_WALL() {
    ...
    static get DOLPHIN_SPAWN_EGG() {
        return this.$javaClass.DOLPHIN_SPAWN_EGG;
    }
    static get DONKEY_SPAWN_EGG() {
    ...
    static get ENDERMAN_SPAWN_EGG() {
        return this.$javaClass.ENDERMAN_SPAWN_EGG;
    }
    static get ENDERMITE_SPAWN_EGG() {
    ...
    static get FURNACE_MINECART() {
        return this.$javaClass.FURNACE_MINECART;
    }
    static get GHAST_SPAWN_EGG() {
    ...
    static get GLISTERING_MELON_SLICE() {
        return this.$javaClass.GLISTERING_MELON_SLICE;
    }
    static get GLOBE_BANNER_PATTERN() {
    ...
    static get OAK_TRAPDOOR() {
        return this.$javaClass.OAK_TRAPDOOR;
    }
    static get OAK_WALL_SIGN() {
    ...
    static get PRISMARINE_BRICKS() {
        return this.$javaClass.PRISMARINE_BRICKS;
    }
    static get PRISMARINE_BRICK_SLAB() {
        return this.$javaClass.PRISMARINE_BRICK_SLAB;
    }
    static get PRISMARINE_BRICK_STAIRS() {
    ...
    static get QUARTZ_PILLAR() {
        return this.$javaClass.QUARTZ_PILLAR;
    }
    static get QUARTZ_SLAB() {
    ...
    static get SALMON_BUCKET() {
        return this.$javaClass.SALMON_BUCKET;
    }
    static get SALMON_SPAWN_EGG() {
    ...
    static get TOTEM_OF_UNDYING() {
        return this.$javaClass.TOTEM_OF_UNDYING;
    }
    static get TRADER_LLAMA_SPAWN_EGG() {
