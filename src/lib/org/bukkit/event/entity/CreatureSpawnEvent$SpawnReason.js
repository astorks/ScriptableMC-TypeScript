export class CreatureSpawnEvent$SpawnReason {
    ...
    static get OCELOT_BABY() {
        return this.$javaClass.OCELOT_BABY;
    }
    static get SILVERFISH_BLOCK() {
