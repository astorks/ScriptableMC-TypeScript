export class EntityTargetEvent$TargetReason {
    ...
    static get CLOSEST_ENTITY() {
        return this.$javaClass.CLOSEST_ENTITY;
    }
    static get FOLLOW_LEADER() {
