...
export default class EntityPotionEffectEvent$Cause {
    ...
    static get ATTACK(): EntityPotionEffectEvent$Cause;
    static get BEACON(): EntityPotionEffectEvent$Cause;
    static get COMMAND(): EntityPotionEffectEvent$Cause;
    static get CONDUIT(): EntityPotionEffectEvent$Cause;
    static get CONVERSION(): EntityPotionEffectEvent$Cause;
    static get DEATH(): EntityPotionEffectEvent$Cause;
    static get DOLPHIN(): EntityPotionEffectEvent$Cause;
    static get EXPIRATION(): EntityPotionEffectEvent$Cause;
    ...
    static get SPIDER_SPAWN(): EntityPotionEffectEvent$Cause;
    static get TOTEM(): EntityPotionEffectEvent$Cause;
