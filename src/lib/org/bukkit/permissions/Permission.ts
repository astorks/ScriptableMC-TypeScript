...
export class Permission {
	...
	public static loadPermissions(data: any, error: string, def: PermissionDefault): any;
	...
	public static loadPermission(_name: string, data: any, def: PermissionDefault, output: any): Permission;
