export default class Particle {
    ...
    static get DAMAGE_INDICATOR() {
        return this.$javaClass.DAMAGE_INDICATOR;
    }
    static get SWEEP_ATTACK() {
        return this.$javaClass.SWEEP_ATTACK;
    }
    static get FALLING_DUST() {
    ...
    static get CAMPFIRE_COSY_SMOKE() {
        return this.$javaClass.CAMPFIRE_COSY_SMOKE;
    }
    static get CAMPFIRE_SIGNAL_SMOKE() {
