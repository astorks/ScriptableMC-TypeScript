...
export default class EnderDragon$Phase {
	...
	public static valueOf(arg0: string): EnderDragon$Phase;
	public static valueOf(enumClass: any, _name: string): any;
	public static valueOf(...args: any[]): any {
		return EnderDragon$Phase.$javaClass.valueOf(...args);
	}

	public static values(): Array<EnderDragon$Phase>;
	public static values(...args: any[]): any {
		return EnderDragon$Phase.$javaClass.values(...args);
	}
