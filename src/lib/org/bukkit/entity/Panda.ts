...
import Panda$Gene from '../../../org/bukkit/entity/Panda$Gene.js'
...
export default interface Panda extends Animals {
	...
	setHiddenGene(arg0: Panda$Gene): void;
	...
	setMainGene(arg0: Panda$Gene): void;
