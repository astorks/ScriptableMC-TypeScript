...
import Ageable from './Ageable.js'
...
export default interface PiglinAbstract extends Monster, Ageable {
...
export default class PiglinAbstract {
	public static get $javaClass(): any {
		return Java.type('org.bukkit.entity.PiglinAbstract');
	}
