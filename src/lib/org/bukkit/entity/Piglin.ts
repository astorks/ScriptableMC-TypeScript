...
import PiglinAbstract from './PiglinAbstract.js'
...
export default interface Piglin extends PiglinAbstract, InventoryHolder {
...
export default class Piglin {
	public static get $javaClass(): any {
		return Java.type('org.bukkit.entity.Piglin');
	}
