...
import Axolotl$Variant from './Axolotl$Variant.js'
...
export default interface Axolotl extends Animals {
	...
	setVariant(arg0: Axolotl$Variant): void;
...
export default class Axolotl {
	public static get $javaClass(): any {
		return Java.type('org.bukkit.entity.Axolotl');
	}
