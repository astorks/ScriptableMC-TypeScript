export class EntityType {
    ...
    static get DROPPED_ITEM() {
        return this.$javaClass.DROPPED_ITEM;
    }
    static get EXPERIENCE_ORB() {
    ...
    static get ILLUSIONER() {
        return this.$javaClass.ILLUSIONER;
    }
    static get MINECART_COMMAND() {
    ...
    static get TRADER_LLAMA() {
        return this.$javaClass.TRADER_LLAMA;
    }
    static get WANDERING_TRADER() {
