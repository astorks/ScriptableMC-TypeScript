...
export default class Keybinds {
	...
	public static get FORWARD(): string {
	...
	public static get HOTBAR_1(): string {
		return Keybinds.$javaClass.HOTBAR_1;
	}

	public static get HOTBAR_2(): string {
		return Keybinds.$javaClass.HOTBAR_2;
	}

	public static get HOTBAR_3(): string {
		return Keybinds.$javaClass.HOTBAR_3;
	}

	public static get HOTBAR_4(): string {
		return Keybinds.$javaClass.HOTBAR_4;
	}

	public static get HOTBAR_5(): string {
		return Keybinds.$javaClass.HOTBAR_5;
	}

	public static get HOTBAR_6(): string {
		return Keybinds.$javaClass.HOTBAR_6;
	}

	public static get HOTBAR_7(): string {
		return Keybinds.$javaClass.HOTBAR_7;
	}

	public static get HOTBAR_8(): string {
		return Keybinds.$javaClass.HOTBAR_8;
	}

	public static get HOTBAR_9(): string {
	...
	public static get LOAD_TOOLBAR_ACTIVATOR(): string {
		return Keybinds.$javaClass.LOAD_TOOLBAR_ACTIVATOR;
	}

	public static get PICK_ITEM(): string {
	...
	public static get SAVE_TOOLBAR_ACTIVATOR(): string {
	...
	public static get SMOOTH_CAMERA(): string {
		return Keybinds.$javaClass.SMOOTH_CAMERA;
	}

	public static get SNEAK(): string {
	...
	public static get SPRINT(): string {
		return Keybinds.$javaClass.SPRINT;
	}

	public static get SWAP_HANDS(): string {
		return Keybinds.$javaClass.SWAP_HANDS;
	}

	public static get TOGGLE_PERSPECTIVE(): string {
		return Keybinds.$javaClass.TOGGLE_PERSPECTIVE;
	}

	public static get USE(): string {
